...
import org.tupol.flink.timeout.demo.{Record, TimeoutSimpleDemo2}
...
/**
 * Simple test for TimeoutSimpleDemo2 using the Flink test infrastructure.
 */
class TimeoutSimpleDemo2Test extends StreamingProgramTestBase with Matchers {
  ...
  def testProgram(): Unit = {
    ...
    Try {
      ...
      TimeoutSimpleDemo2.demoStreamProcessor(inputStream, outputFile, 1000)
