...
import org.apache.flink.streaming.util.{StreamingMultipleProgramsTestBase, TestStreamEnvironment}
 ...
 *
 */
trait FlinkStreamingEnvironmentsSpec extends StreamingMultipleProgramsTestBase with FlinkCusterSpec with BeforeAndAfterEach {
  this: Suite =>
